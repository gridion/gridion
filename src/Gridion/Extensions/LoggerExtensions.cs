...
namespace Gridion.Core.Extensions
{
    ...
    internal static class LoggerExtensions
    {
        ...
        ///     The message.
        /// </param>
        internal static void Error([NotNull] this ILogger logger, [NotNull] string message)
        {
            Should.NotBeNull(logger, nameof(logger));
            Should.NotBeNull(message, nameof(message));

            logger.Log(LogLevel.Error, message, null, null, null);
        }
        ...
        ///     The message.
        /// </param>
        internal static void Info([NotNull] this ILogger logger, [NotNull] string message)
        {
            Should.NotBeNull(logger, nameof(logger));
            Should.NotBeNull(message, nameof(message));
