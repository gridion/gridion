// <copyright file="MessengerService.cs" company="Gridion">
...
namespace Gridion.Core.Services
{
    ...
    internal abstract class MessengerService : Disposable, IMessengerService
    {
        /// <summary>
        ...
        /// </param>
        protected MessengerService(string name)
        {
            this.Name = name;
        }

        /// <summary>
        ///     Finalizes an instance of the <see cref="MessengerService" /> class.
        /// </summary>
        /// <inheritdoc cref="Disposable" />
        ~MessengerService()
        {
        ...
        /// <inheritdoc />
        public abstract IMessage Accept();

        /// <inheritdoc />
        public abstract void SendToAll(IMessage message);
