...
namespace Gridion
{
    ...
    internal static class Should
    {
        ...
        /// </exception>
        [DebuggerStepThrough]
        [SuppressMessage("ReSharper", "ParameterOnlyUsedForPreconditionCheck.Global", Justification = "It is OK here.")]
        internal static void BePositive(int value, string name)
        {
            if (value <= 0)
            {
                throw new ArgumentException(Resources.ResourceManager.GetString("ShouldBeGreaterThanZero", CultureInfo.CurrentCulture), name);
            }
        }
        ...
        internal static void BeTrue(bool value, string name)
        {
            if (!value)
            {
                throw new ArgumentException(Resources.ResourceManager.GetString("ShouldBeTrue", CultureInfo.CurrentCulture), name);
            }
        }
