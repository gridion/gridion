// <copyright file="Endpoint.cs" company="Gridion">
...
namespace Gridion
{
    ...
    /// </summary>
    /// <inheritdoc />
    internal sealed class Endpoint : IPEndPoint
    {
        ...
        /// </returns>
        internal static Endpoint GetDefault()
        {
            return new Endpoint("127.0.0.1", 24000);
        }
    }
}