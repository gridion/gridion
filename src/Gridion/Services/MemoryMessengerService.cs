...
namespace Gridion.Services
{
    ...
    /// </summary>
    /// <inheritdoc />
    internal sealed class MemoryMessengerService : MessengerService
    {
        /// <inheritdoc cref="GridionService" />
        internal MemoryMessengerService()
            : base("MemoryMessengerService")
        {
        }

        /// <inheritdoc />
        public override void Send(IEnumerable<IRecipient> recipients, IMessage message)
        {
